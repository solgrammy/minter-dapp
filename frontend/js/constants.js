...
const welcome_h1 = "Welcome to the Moodles Mob!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = '522 0G Moodles mobbin through the Metaverse. The revolutionary Moodles DAO aims to advance the Web3 ecosystem through  innovative blockchain technology development.';
const h1_presale_coming_soon = "0G Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the Moodles 1st Generation Collection. Follow Us on Twitter for updates. @moodlesmob!";
