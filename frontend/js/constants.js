const contractAddress = "0x2F519bA06Af1Cbad6C82B06eB8b5049F00604D18"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Meet the Moodles Mob!!";
const welcome_h2 = "Connect to MetaMask Moodle";
const welcome_p = 'Follow us on the <a href="https://twitter.com/moodlesmob"  target="_blank" rel="noopener noreferrer">Moodles Mob</a> Twitter.';
const h1_presale_coming_soon = "Moodles Mob Mobbing Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "We are working hard to launch the Moodles Mob 1st Generation Collection. Stay tuned for updates!";
...
const button_presale_mint_whitelisted = "Mint Your Moodle";
const button_presale_mint_not_whitelisted = "Get on the Whitelist";
const button_presale_already_minted = "Join The Moodles Mob";
const button_public_mint = "Mint Your Moodle";
